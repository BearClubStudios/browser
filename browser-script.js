...
document.addEventListener('DOMContentLoaded', function () {
      ...
      svgElement.addEventListener('click', function () {        
        ...
        //   const n_small = Math.floor(containerWidth / Math.ceil(posX3 / 239) - 1);
        //   console.log("Total available width for the tabs:", Math.floor(n_small), "pixels");
        

        // const maxTabs = Math.floor(containerWidth / 250);
        //   if (containerDiv.childElementCount >= maxTabs) {
        //     const info = document.createElement('div');
        //     info.className = 'modal';
        //     info.innerHTML = `
        //         <div class="modal-content">
        //             <span class="close">&times;</span>
        //             <h2>You Can't Add More Tabs</h2>
        //             <p>Your screen just doesn't look it can handle more tabs</p>
        //             <p>Try upgrading to a bigger one to get more tabs</p>
        //         </div>
        //     `;
  ...
  infoButton.addEventListener('click', function () {     
      ...
      document.addEventListener("keydown", function (event) {
          if (event.key === "!") {
              ...
              if (linkElement.getAttribute("href") === "css/browser-style.css") {
                  linkElement.setAttribute("href", "css/browser-style-Darkmode.css");
                  fbLogo.src = '/img/white_logo.png';
              } else {
                  linkElement.setAttribute("href", "css/browser-style.css");
                  fbLogo.src = '/img/black_logo.png';
              }
          }
      });  
